...
![image.png](https://raw.githubusercontent.com/Tendourisu/images/master/20250305213707606.png)

我们从中取三个点，得到欲求的三组数据如下表：

|          |    夹断区     |        恒流区        |       可变电阻区       |
| -------- | :--------: | :---------------: | :---------------: |
| $R$      | 0 $\Omega$ | 21.0377k $\Omega$ | 37.8302k $\Omega$ |
| $I_C$    | 39.6593pA  |     3.0120mA      |     4.7935mA      |
| $U_{BE}$ |     0V     |    656.5231mV     |    669.6298mV     |
| $U_{CE}$ |     5V     |      1.9880V      |    204.7184mV     |
